...
export const TOOLS: ToolMeta[] = [
  ...
  { slug: "exif-viewer", name: "EXIF Viewer / Remover", description: "View and strip metadata from photos.", category: "image", available: false },
  { slug: "image-base64", name: "Image Base64 Encoder", description: "Convert images to and from Base64.", category: "image", available: false },
  { slug: "color-picker", name: "Color Picker from Image", description: "Pick colors from any pixel of an image.", category: "image", available: false },
  { slug: "collage-maker", name: "Collage Maker", description: "Combine multiple images into a collage.", category: "image", available: false },
  { slug: "meme-generator", name: "Meme Generator", description: "Add top and bottom captions to images.", category: "image", available: false },
  { slug: "svg-converter", name: "SVG to PNG / JPG", description: "Rasterize SVG files to images.", category: "image", available: false },
  { slug: "favicon-generator", name: "Favicon Generator", description: "Generate favicons in multiple sizes.", category: "image", available: false },

  // PDF
  { slug: "merge-pdf", name: "Merge PDFs", description: "Combine multiple PDFs into one.", category: "pdf", available: false },
  { slug: "split-pdf", name: "Split PDF", description: "Split a PDF by page ranges.", category: "pdf", available: false },
  { slug: "extract-pages", name: "Extract / Remove Pages", description: "Keep or delete specific pages.", category: "pdf", available: false },
  { slug: "organize-pdf", name: "Organize Pages", description: "Reorder pages with drag and drop.", category: "pdf", available: false },
  { slug: "rotate-pdf", name: "Rotate Pages", description: "Rotate PDF pages.", category: "pdf", available: false },
  { slug: "crop-pdf", name: "Crop Pages", description: "Crop the visible area of PDF pages.", category: "pdf", available: false },
  { slug: "protect-pdf", name: "Password Protect", description: "Add or remove a PDF password.", category: "pdf", available: false },
  { slug: "watermark-pdf", name: "Add Watermark", description: "Stamp text or image watermarks.", category: "pdf", available: false },
  { slug: "page-numbers", name: "Add Page Numbers", description: "Insert page numbers into a PDF.", category: "pdf", available: false },
  { slug: "header-footer", name: "Header & Footer", description: "Add headers and footers to a PDF.", category: "pdf", available: false },
  { slug: "pdf-metadata", name: "Edit Metadata", description: "Edit title, author and more.", category: "pdf", available: false },
  { slug: "compress-pdf", name: "Compress PDF", description: "Recompress embedded images.", category: "pdf", available: false },
  { slug: "extract-images", name: "Extract Images", description: "Pull images out of a PDF.", category: "pdf", available: false },
  { slug: "extract-text", name: "Extract Text", description: "Extract text content from a PDF.", category: "pdf", available: false },
  { slug: "pdf-to-image", name: "PDF to JPG / PNG", description: "Render PDF pages as images.", category: "pdf", available: false },
  { slug: "image-to-pdf", name: "Images to PDF", description: "Combine images into a PDF.", category: "pdf", available: false },
  { slug: "pdf-info", name: "PDF Info Viewer", description: "View page count and basic info.", category: "pdf", available: false },

  // Video
  { slug: "video-trimmer", name: "Video Trimmer", description: "Cut and trim video clips.", category: "video", available: false },
  { slug: "video-compressor", name: "Video Compressor", description: "Reduce video file size.", category: "video", available: false },
  { slug: "video-converter", name: "Video Converter", description: "Convert MP4, WebM and MOV.", category: "video", available: false },
  { slug: "extract-audio", name: "Extract Audio", description: "Pull the audio track from a video.", category: "video", available: false },
  { slug: "video-to-gif", name: "Video to GIF", description: "Turn clips into animated GIFs.", category: "video", available: false },
  { slug: "screen-recorder", name: "Screen Recorder", description: "Record your screen locally.", category: "video", available: false },
